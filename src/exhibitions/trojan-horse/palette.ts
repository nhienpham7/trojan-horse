import type { Palette, ProceduralFn } from '../../engine/types'

export const TROJAN_HORSE_PALETTE: Palette = {
...
export const trojanHorseProcedural: ProceduralFn = (id, ctx, S, palette) => {
